...
export const StoredGame = {
  encode(message: StoredGame, writer: Writer = Writer.create()): Writer {
    ...
    if (message.deneom !== "") {
      writer.uint32(98).string(message.deneom);
    }
    return writer;
  },
  ...
  fromJSON(object: any): StoredGame {
    ...
    if (object.deneom !== undefined && object.deneom !== null) {
      message.deneom = String(object.deneom);
    } else {
      message.deneom = "";
    }
    return message;
  ...
  toJSON(message: StoredGame): unknown {
    ...
    message.deneom !== undefined && (obj.deneom = message.deneom);
    return obj;
  },
